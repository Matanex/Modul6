...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void addMahasiswa(){
        ...
        class AddMahasiswa extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... v) {
                ...
                params.put(Configuration.KEY_MHS_NAMA,name);
                params.put(Configuration.KEY_MHS_JURUSAN,desg);
                params.put(Configuration.KEY_MHS_EMAIL,sal);
    ...
    public void onClick(View v) {
        ...
        if(v == buttonView){
            startActivity(new Intent(this, ShowAllDataStudents.class));
        }
    }
}
