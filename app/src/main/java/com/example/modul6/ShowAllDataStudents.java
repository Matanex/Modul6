...
public class ShowAllDataStudents extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void showMahasiswa(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                ShowAllDataStudents.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ShowAllDataStudents.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra(Configuration.MHS_ID,empId);
