...
public class ShowAllData extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = intent.getStringExtra(Configuration.MHS_ID);
    ...
    private void getMahasiswa(){
        class GetMahasiswa extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ShowAllData.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void showMahasiswa(String json){
        try {
            ...
            String desg = c.getString(Configuration.TAG_JURUSAN);
            String sal = c.getString(Configuration.TAG_EMAIL);
    ...
    private void updateMahasiswa(){
        ...
        class UpdateMahasiswa extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ShowAllData.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(ShowAllData.this,s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(Configuration.KEY_MHS_NAMA,name);
                hashMap.put(Configuration.KEY_MHS_JURUSAN,desg);
                hashMap.put(Configuration.KEY_MHS_EMAIL,salary);
    ...
    private void deleteMahasiswa(){
        class DeleteMahasiswa extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ShowAllData.this, "Updating...", "Tunggu...", false, false);
            }
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteMahasiswa();
                        startActivity(new Intent(ShowAllData.this, ShowAllDataStudents.class));
                    }
                });
